...
class latestRemdies extends StatefulWidget {
  const latestRemdies({super.key});

  @override
  _latestRemdiesState createState() => _latestRemdiesState();
}

class _latestRemdiesState extends State<latestRemdies> {
      ...
      body: FutureBuilder<Articles>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            // Limit the articles to only display 3
            final displayedArticles = snapshot.data!.articles.take(3).toList();
